...
<a href="http://apps.facebook.com/<?= APP_SUFFIX ?>" target="_parent"> <h2>Back to Smiley</h2> </a>
...
<script type="text/javascript">
    ...
    FB_RequireFeatures(["Integration"], function() {
        // Change the first arg to your api key, and the second to the path to your xd_receiver.htm file.
        // You can copy my xs_receiver.htm from http://somethingtoputhere.com/smiley/iframe/xd_receiver.htm to your server and it will work fine.
        FB.Facebook.init('<?php echo API_KEY;?>','xd_receiver.htm', null);
