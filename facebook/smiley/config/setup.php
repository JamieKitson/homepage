...
require_once $settings['MAIN_PATH'].'client/facebook.php';
require_once $settings['MAIN_PATH'].'lib/display.php';
...
// Set info options
$options  = array(array('label'=> 'Happy',
                         'image' => 'http://www.somethingtoputhere.com/smiley/images/smile0.jpg',
                         'sublabel'=>'',
                         'description'=>'The original and still undefeated.',
                         'link'=>'http://apps.facebook.com/'.APP_SUFFIX.'/smile.php?smile=1'),
                   array('label'=>'Indifferent',
                         'image'=> 'http://www.somethingtoputhere.com/smiley/images/smile1.jpg',
                         'description'=>'meh...',
                         'link'=>'http://www.facebook.com'),
                   array('label'=>'Sad',
                         'image'=> 'http://www.somethingtoputhere.com/smileyimages/smile2.jpg',
                         'description'=>'Oh my god! you killed my dog!',
                         'link'=>'http://www.facebook.com'),
                   array('label'=>'Cool',
                         'image'=> 'http://www.somethingtoputhere.com/smiley/images/smile3.jpg',
                         'link'=>'http://www.facebook.com',
                         'description'=>'Yeah. whatever'));

$res = $fb->api_client->profile_setInfoOptions('Good Smilies', $options);
